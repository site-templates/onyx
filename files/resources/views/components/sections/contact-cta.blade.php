...
<section id="contact" class="border-t border-line py-20 sm:py-32">
    <div class="mx-auto w-full max-w-[100rem] px-5 text-center sm:px-8 lg:px-10">
        ...
        <p class="mx-auto mt-8 max-w-[24ch] font-display text-4xl/[1.1] font-medium tracking-tight text-balance sm:text-5xl/[1.08] lg:text-[3.5rem]/[1.06]" data-reveal>{{ $heading }}</p>
