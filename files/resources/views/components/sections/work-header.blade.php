...
-->
<section class="pt-8 pb-4 sm:pt-10">
    <div class="mx-auto w-full max-w-[100rem] px-5 sm:px-8 lg:px-10">
        ...
        <dl class="mt-12 grid grid-cols-2 gap-x-8 gap-y-6 border-t border-line pt-8 sm:mt-16 lg:grid-cols-4" data-reveal>
        ...
        <div class="mt-10 overflow-hidden rounded-2xl bg-well" data-reveal>
