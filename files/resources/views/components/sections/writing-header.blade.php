...
<!--
    The article opener: the back link sits on the page's left edge, the way
    every other page in the template anchors it, then the mono date and read
    time and the display title open the centred reading column the body
    continues. Content values are bound from the matched entry.
-->
